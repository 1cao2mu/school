package com.hhstu.cyy.school.sqlitedata;
...
public class MySqliteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //执行数据库语句
        db.execSQL(sql);
        sql = "insert into findTab values(1,1,'管理员','','总是有同学秀恩爱,在餐厅虐狗','',1,0,0,'[1]','','')";
        //执行数据库语句
        db.execSQL(sql);
        sql = "insert into findTab values(2,1,'管理员','','总是有同学秀恩爱,在图书馆虐狗','',0,1,0,'','[1]','')";
        //执行数据库语句
        db.execSQL(sql);
        sql = "insert into findTab values(3,1,'管理员','','总是有同学秀恩爱,在操场虐狗','',0,0,1,'','','[1]')";
        //执行数据库语句
        db.execSQL(sql);
