...
import com.hhstu.cyy.school.activity.Tab3NewDetailActivity;
import com.hhstu.cyy.school.activity.addFindTab1Activity;
import com.hhstu.cyy.school.activity.addNewTab3Activity;
...
public class Tab3Fragment extends Fragment implements View.OnClickListener, OnItemChildViewClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tv_title)).setText("资讯");
    ...
    private void initData() {
        try {
            JSONArray array = Data.getNewTabData(new MySqliteHelper(getContext()), page);
            if (adapter != null) {
                if (page == 1) {
                    if (array.length() == 0) {
                ...
                adapter.setOnItemChildViewClickListener(Tab3Fragment.this);
    ...
    public void onClick(View v) {
        ...
        if (Utils.isLogin(getContext())) {
            switch (v.getId()) {
                case R.id.iv_action:
                case R.id.tv_go:
                    intent = new Intent(getContext(), addNewTab3Activity.class);
            ...
            if (Utils.isLogin(getContext())) {
                switch (id) {
                    case R.id.iv_ding:
                        ...
                        num = db1.update("newTab", values, "fid = ?", new String[]{String.valueOf(object.getInt("fid"))});
                        if (num < 1) {
                    ...
                    case -1:
                        intent = new Intent(getContext(), Tab3NewDetailActivity.class);
