package com.hhstu.cyy.school.View;
...
public class CheckCodeButton extends LinearLayout implements Runnable, View.OnClickListener {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == HANDLER_UPDATE) {
                ...
                tv_timer.setTextColor(getResources().getColor(R.color.text_red));
                tv_text.setTextColor(getResources().getColor(R.color.text_red));
                setFocusable(true);
                setClickable(true);
            }
        }
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(check)) {
            ...
            tv_timer.setTextColor(getResources().getColor(R.color.text_gray));
            tv_text.setTextColor(getResources().getColor(R.color.text_gray));
