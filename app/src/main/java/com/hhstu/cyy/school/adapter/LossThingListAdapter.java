 ...
 */
public class LossThingListAdapter extends RecyclerView.Adapter<LossThingListAdapter.ViewHolder> {
    JSONArray array;
    Context context;
    ...
    public LossThingListAdapter(JSONArray array, Context context) {
        this.array = array;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_loss_thing, null);
